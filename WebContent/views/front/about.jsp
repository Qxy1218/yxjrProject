        ...
        <div class="mo2-indLogreg" style="display: none">
            ...
            <div class="mo2-indRegboxRight" style="display:none;">
                ...
                <div class="mo2-indLogitem-step1">
                    ...
                    <img class="mo2-indRegcode" src="/Finances/statics/front/statics/home2/images/home-register-VerifyCode.png" onClick="document.getElementById('reverifyCodeRight').src='home-register-VerifyCode.png'+Math.random();void(0);" id="reverifyCodeRight"  alt="点击刷新验证码">
