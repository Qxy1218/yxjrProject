	    ...
	    <div class="m2-detialsItem">
	        <div class="m2-detItemlef">
	            <div class="m2-detItemlef-img">
	                ...
	                <script type="text/javascript" src="/Finances/statics/front/statics/common/ZeroClipboard/ZeroClipboard_mo.js"></script>
	                <script>
	                    var clip = null;
	                    function initCopy() {
	                        ZeroClipboard.setMoviePath("/Finances/statics/front/statics/common/ZeroClipboard/ZeroClipboard.swf");
