        ...
        <div class="mo2-indLogreg" style="display: none">
            ...
            <div class="mo2-indRegboxRight" style="display:none;">
                <div class="mo2-indLogitem" style="margin-bottom:6px;">
                    ...
                    <em class="mo2-indlogWar-arr"></em><u></u></b>
                </div>
                <div class="mo2-indLogitem" style="margin-bottom:6px;">
                ...
                <div class="mo2-indLogitem-step1">
                    ...
                    <img class="mo2-indRegcode" src="/Finances/statics/front/statics/home2/images/code.png" onClick="document.getElementById('reverifyCodeRight').src='code.png?time='+Math.random();void(0);" id="reverifyCodeRight"  alt="点击刷新验证码">
            ...
            <div class="mo2-indLogboxRight">
                ...
                <div class="mo2-indLog-code" style="display:none;margin-bottom:8px;">
                    ...
                    <img src="/Finances/statics/front/statics/home2/images/code.png" onClick="document.getElementById('reverifyCode').src='code.png?time='+Math.random();void(0);" alt="点击刷新验证码"></div>
                </div>
