        ...
        <div class="mo2-indLogreg" style="display: none">
            ...
            <div class="mo2-indRegboxRight" style="display:none;">
                ...
                <div class="mo2-indLogitem-step1">
                    <div class="mo2-indLogreg-step1">
	                    ...
	                    <img class="mo2-indRegcode" src="/Finances/statics/front/statics/home2/images/home-register-VerifyCode.png" onClick="document.getElementById('reverifyCodeRight').src='Index-VerifyCode.png?time='+Math.random();void(0);" id="reverifyCodeRight"  alt="点击刷新验证码">
            ...
            <div class="mo2-indRegbox2Right"  style="display:none;" >
                <div class="mo2-indReg2-con">
                    <ul>
                        <li>
                        	<i class="mo2-indRegicon-step1"></i>
                        	   	<span>为了确保您手机可用，请填写您收到的手机动态码。</span>
                        </li>
                        <li>
                        	<i class="mo2-indRegicon-step2"></i>
                        	<span>如收不到短信验证码，可点击下面的获取语音验证码。</span>
                        </li>
                    </ul>
                </div>
                <div class="mo2-indLogitem">
                    <i class="mo2-indLogicon-code"></i>
                    <input class="mo2-indIpt-half" id="codeRight" type="text" placeholder="验证码">
                    	<span class="mo2-indRegtim mo2-regTin-able">
                    	<u>60秒后</u>
                    		<span>获取手机验证码</span>
                    	</span>
                    <b class="mo2-indLogwarRight" style="width:200px;">
                    	<em class="mo2-indlogWar-arr"></em>
                    	<u>错误提示信息</u>
                    </b>
                </div>
            ...
            <div class="mo2-indLogboxRight">
                <div class="mo2-indLogitem mo2-indLogitem-use" style="margin-bottom:9px;">
                    <i class="mo2-indLogicon-use"></i>
                    		<input class="mo2-indIpt-all" type="text" id="user_nameRight" placeholder="用户名/手机号">
                    		<b class="mo2-indLogwar" id="w_username">
                    		<em class="mo2-indlogWar-arr"></em>
                    	<u id="r_usernameRight"></u></b>
                </div>
                <div class="mo2-indLogitem mo2-indLogitem-psw" style="margin-bottom:9px;">
                    <i class="mo2-indLogicon-psw"></i>
                    		<input class="mo2-indIpt-all m2-ind-banPsw" maxlength="20" id="pass_wordRight" type="password" id="pass_wordRight" placeholder="输入登录密码">
                    	<b class="mo2-indLogwar" id="w_password">
                    		<em class="mo2-indlogWar-arr"></em>
                   			<u id="r_passwordRight"></u>
                    	</b>
                </div>
                <div class="mo2-indLog-code" style="display:none;margin-bottom:8px;">
                    ...
                    <div class="mo2-indLogcod-rig">
                    	<img src="Index-VerifyCode.png" onClick="document.getElementById('reverifyCode').src='Index-VerifyCode.png?time='+Math.random();void(0);" alt="点击刷新验证码">
                    </div>
                </div>
        ...
        <div class="m2-commonRight2"  id="m2-commonRight">
            <ul class="m2-comRiglist myclick">
                <li class="m2-comRigli m2-comRigli-ewm m2-comRigli_new" style="border-top:1px solid #fff;" data="#fixnavbar_one">
                    ...
                    <div class="toAbs">
                        <div>
                        	<img src="/Finances/statics/front/statics/home2/images/fixedl-1_v2.png" alt="我的账户"></div>
                        <div>
                        </div>
                    </div>
                </li>
                <li class="m2-comRigli m2-comRigli-tel m2-comRigli_new" data="#fixnavbar_two">
                    ...
                    <div class="toAbs">
                        <div>
                        	<img src="/Finances/statics/front/statics/home2/images/fixedl-2_v2.png" alt="我的红包"></div>
                        <div>
                        </div>
                    </div>
                </li>
                <li class="m2-comRigli m2-comRigli-qq m2-comRigli_new" data="#fixnavbar_three">
                    ...
                    <div></div>
                    	<div class="toAbs">
                    <div>
                    	<img src="/Finances/statics/front/statics/home2/images/fixedl-3_v2.png" alt="我的加息券"></div>
                    <div>
                    </div>
                </div>
                </li>
                <li class="m2-comRigli m2-comRigli-sug m2-comRigli_new" data="#fixnavbar_four">
					...
					<div class="toAbs">
                <div>
                    	<img src="/Finances/statics/front/statics/home2/images/fixedl-4_v2.png" alt="站内信息"></div>
                    <div>
                    </div>
                </div>
                </li>
        ...
        <div class="m2-commonRight">
            <ul class="m2-comRiglist">
                ...
                <li class="m2-comRigli m2-comRigli-sug" style="border-bottom: 1px solid #fff;">
                    <i class="m2-comRigli-icon"></i>
                    <span class="m2-comRigli-hov">
                    	<a href="/Finances/tohelp" style="color:#fff;">帮助<br>中心</a>
                    </span>
                </li>
...
<!--头部start-->
    ...
    <div class="security_ensure_two">
        ...
        <div class="content">
            <div class="lefthover">
                <span>提供担保和债权回购</span>
                <img src="/Finances/statics/front/statics/home2/images/security/securitythree.png" style="vertical-align:-2px;margin-left:2px;">
                <div class="detail" style="color:#959595;">
                    <img src="/Finances/statics/front/statics/home2/images/security/securityfour.png" class="detail_title">
    ...
    <div class="security_ensure_three">
        <div class="container">
            <img src="/Finances/statics/front/statics/home2/images/security/securityfive.png">
        ...
        <div class="container">
            <img src="/Finances/statics/front/statics/home2/images/security/securitysix.png" class="right">
        ...
        <div class="container">
            <img src="/Finances/statics/front/statics/home2/images/security/securityseven.png">
        ...
        <div class="container">
            <img src="/Finances/statics/front/statics/home2/images/security/securityeight.png" class="right">
            <div class="container_style">
        ...
        <div class="container">
            <img src="/Finances/statics/front/statics/home2/images/security/securitynine.png">
        ...
        <div class="container" style="margin-bottom:0;">
            <img src="/Finances/statics/front/statics/home2/images/security/securityten.png" class="right">
            <div class="container_style">
    ...
    <div class="security_ensure_four">
        <div class="security_ensure_content_title">
        <div class="left solid"></div>实力合作机构<div class="right solid">
        </div>
       	</div>
