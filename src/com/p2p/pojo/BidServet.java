 ...
 * 投标的服务基本类
 * */
public class BidServet implements Serializable{
	...
	public BidServet(Integer itid, String ittitle, Integer itsuid, double itmoney, String ittime, Integer itstate,
